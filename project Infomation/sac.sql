...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2589394861ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="226">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sac&table=hostel_leave_form">`sac`.`hostel_leave_form`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sac&table=cmplnrpt">`sac`.`cmplnrpt`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sac&table=notices">`sac`.`notices`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sac&table=notice">`sac`.`notice`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sac&table=userlogin">`sac`.`userlogin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sac&table=user">`sac`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sac&table=complainreport">`sac`.`complainreport`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sac&table=Hostel_leave_form">`sac`.`Hostel_leave_form`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sac&table=Contact">`sac`.`Contact`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sac&table=contact">`sac`.`contact`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2624506177517673236a577d634e6639">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="226"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
